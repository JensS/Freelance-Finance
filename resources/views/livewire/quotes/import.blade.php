<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Angebote Importieren</h1>
            <p class="mt-1 text-sm text-gray-500">Importieren Sie Angebote aus PDF-Dateien</p>
        </div>
        <a
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="p-6">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">Wählen Sie eine oder mehrere PDF-Dateien mit Angeboten zum Importieren aus.</p>
            </div>
            ...
            @if(count($files) > 0)
                <div class="mt-6 flex justify-end">
                    ...
                    >
                        <span wire:loading.remove>Angebote importieren</span>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-lg @if($result['status'] === 'success') bg-green-50 @else bg-red-50 @endif">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    @if(isset($result['quote_number']))
                                        <p class="text-xs text-gray-500 mt-1">Angebotsnr.: {{ $result['quote_number'] }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
