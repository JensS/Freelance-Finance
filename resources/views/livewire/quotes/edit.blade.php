<div>
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Angebot bearbeiten</h1>
                <p class="mt-1 text-sm text-gray-500">Angebot {{ $quote->quote_number }}</p>
            </div>
            <div class="text-sm text-gray-500">
                Erstellt am: {{ $quote->created_at ? $quote->created_at->format($dateFormat . ' H:i') : '' }}
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <!-- Quote Type and Details -->
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">Angebotsdetails</h3>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <!-- Project Name (shown only for project type) -->
                    @if($type === 'project')
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            <label for="issue_date" class="block text-sm font-medium text-gray-700">
                                Angebotsdatum <span class="text-red-500">*</span>
                            </label>
                            <input
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div>
                    <label for="notes" class="block text-sm font-medium text-gray-700">
                        Brief / Zusätzliche Informationen
                    </label>
                    <textarea
                        wire:model="notes"
                        id="notes"
                        rows="3"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        placeholder="Dieser Text erscheint im Brief-Abschnitt des Angebots"
                    ></textarea>
                </div>
            </div>
        </div>
