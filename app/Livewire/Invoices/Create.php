...
class Create extends Component
{
    ...
    public function mount()
    {
        ...
        $defaultVatRate = Setting::get('vat_rate', 19);
        $this->vat_rate = is_numeric($defaultVatRate) ? (float) $defaultVatRate : 19.0;
    ...
    public function save()
    {
        ...
        // Wrap in transaction to ensure invoice number sequence integrity (German law requirement)
